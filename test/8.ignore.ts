...
function createFiles(workdir : string, ...names : string[]): void {
...
test('Ignore Manager plain [foo, bar, bas]', (t) => {
...
test('Ignore Manager plain [foo/bar]', (t) => {
...
test('Ignore Manager [*.log, !important.log]', (t) => {
...
test('Ignore Manager [foo, !foo/bar/bas]', (t) => {
...
test('Ignore Manager [foo/*/bar, !foo/*/bas]', (t) => {
...
test('Root Test 2 [**/logs/debug.log]', (t) => {
...
test('Root Test 2 [/foo/bar] [/foo/bar/] [/foo/bar/**]', (t) => {
...
test('Ignore Manager [foo/*/baz], [foo/*/baz/], [foo/*/baz/**]', (t) => {
...
test('Ignore Manager [debug[01].log]', (t) => {
...
test('Ignore Manager [debug?.log]', (t) => {
...
test('Ignore Manager [foo/bar[1-4]]', (t) => {
